...
const VendorOrders = () => {
  ...
  const calculateTotalRevenue = () => {
    return filteredOrders
      ...
      .reduce((total, order) => {
        // Assuming cart has a total property
        const orderTotal = order.cart?.total || 0;
            ...
            <div>
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <p><strong>Name:</strong> {currentOrder.user?.username || 'Unknown'}</p>
                  <p><strong>Email:</strong> {currentOrder.user?.email || 'Not available'}</p>
                </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <h5>Order Summary</h5>
                  <p><strong>Total Items:</strong> {currentOrder.cart?.items?.length || 0}</p>
                  <p><strong>Total Amount:</strong> ${currentOrder.cart?.total || '0.00'}</p>
                </div>
              </div>
                ...
                <table className="table table-bordered">
                  ...
                  <tbody>
                    {currentOrder.cart?.items?.length > 0 ? (
                      currentOrder.cart.items.map((item, index) => (
                        <tr key={index}>
                          <td>{item.rental_item?.name || 'Unknown Product'}</td>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td>${currentOrder.cart?.total || '0.00'}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
