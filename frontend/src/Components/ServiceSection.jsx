  ...
  const services = [
    {
      ...
      description: 'Register to participate in traditional Newari ceremonies: Bhintuna festival celebrating new beginnings, Gai Jatra honoring deceased loved ones, and Ihi, the sacred pre-puberty ritual for girls.',
      link: '/register-event'
    },
    {
      id: 2,
      ...
      description: 'Book pandits for Ihi ceremony, also known as Bel Bibaha. Our pandits will guide you through this traditional marriage ritual that holds deep cultural significance for Newari girls.',
      link: '/register/12'
    },
    {
      id: 3,
      title: 'Rent Traditional Attire',
      icon: (
        <svg className="service-icon" viewBox="0 0 24 24" fill="currentColor">
      ...
      description: 'Access authentic traditional attire. Available in various sizes with rental periods to suit your needs.',
      ...
      <div className="container">
        <div className="text-center mb-5">
          ...
          <p className="section-subtitle">
            Celebrating Newari Cultural Traditions
          </p>
        </div>
