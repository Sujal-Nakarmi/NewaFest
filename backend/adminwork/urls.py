...
from .views import list_events, manage_event, update_event, delete_event, register_for_event, get_user_registrations, public_list_events, get_category, get_rallyoptions, get_all_user_registrations, get_rally_laps, get_newari_instruments, get_volunteer_laps, get_volunteer_types, get_stall_types, get_stall_locations
