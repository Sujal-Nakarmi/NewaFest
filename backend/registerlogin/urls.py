...
from .views import register_user, register_pandit, protected_view, get_user_profile, CustomTokenObtainPairView, create_admin, create_first_admin, manage_user, admin_dashboard, admin_create_user, admin_create_pandit, promote_to_vendor, update_user_profile, change_password, submit_inquiry
...
urlpatterns = [
    ...
    path('api/inquiry/submit/', submit_inquiry, name='submit_inquiry'),
]
